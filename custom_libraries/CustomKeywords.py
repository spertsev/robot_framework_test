...
def verify_city_name_after_change(entered_city_name):
    ...
    time.sleep(3)
    city_input_bar = driver.find_element(By.XPATH, '//input[@placeholder='Search a city...']')
    city_input_bar.send_keys(entered_city_name)
    city_input_bar.send_keys(Keys.ENTER)
    time.sleep(3)
    city_name_element = driver.find_element(By.XPATH, '//h1[contains(@class,'MainCard_location__Zmash')]')
